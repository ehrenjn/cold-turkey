/*
How to nicely make double and float version?
Should I move documentation comments to header file instead?
If header file only declares "public" functions that works right?
should probably make helper functions static
*/
...
void dft_loops(float* signal_real, float* signal_imaginary, float* freqs_real, float* freqs_imaginary, 
...
void sort_in_bit_reversed_order(float* array, uint32_t length) {
...
int radix_2_cooley_tukey(float* freqs_real, float* freqs_imaginary, uint32_t total_length, int direction) {
...
*/
void dft(float* signal_real, float* signal_imaginary, float* freqs_real, float* freqs_imaginary, uint32_t length) {
...
length: the length of all the arrays (they must all be the same length)
*/
void idft(float* freqs_real, float* freqs_imaginary, float* signal_real, float* signal_imaginary, uint32_t length) {
    dft_loops(signal_real, signal_imaginary, freqs_real, freqs_imaginary, length, 1, length);
}
...
*/
int fft(float* signal_real, float* signal_imaginary, uint32_t length) {
...
*/
int ifft(float* freqs_real, float* freqs_imaginary, uint32_t length) {
...
length: the length of all the arrays (they must all be the same length)
*/
int fft_out_of_place(float* signal_real, float* signal_imaginary, float* freqs_real, float* freqs_imaginary, uint32_t length) {
...
length: the length of all the arrays (they must all be the same length)
*/
int ifft_out_of_place(float* freqs_real, float* freqs_imaginary, float* signal_real, float* signal_imaginary, uint32_t length) {
